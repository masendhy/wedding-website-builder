    ...
    <div class="row mb-3">
        ...
        <div class="col-xl-6 col-lg-6 mb-4">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text">Pengaturan Undangan</h6>
                </div>
                <div class="card-body">
                    <div class="form-group">
                    <label>Nama Domain / URL Undangan</label>
                    <label style="bottom: -12.3px;position: inherit;padding-left: 15px;color: #f39191;font-weight: bold;display: table;margin-bottom: -2.1rem;">weddingpage.website/</label>
        ...
        <div class="col-xl-6 col-lg-6 mb-4">
         <!-- Form Basic -->
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text">Fitur Undangan</h6>
                </div>
                <div class="card-body">
                    <div class="form-group">
        ...
        <div class="col-xl-6 col-lg-6 mb-4">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text">Musik</h6>
                </div>
                <div class="card-body">
