...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="row mb-3">
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text">Pengunjung 7 Hari Terakhir</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-8 col-lg-7 mb-4">
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text">Data Pengunjung</h6>
            ...
            <div class="card">
                ...
                <div>
                    ...
                    <div class="card-footer text-center">
                        <a class="m-0 small text card-link" href="<?= base_url('user/ucapan') ?>">Lihat Lebih <i class="fas fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
