...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="row mb-3">
        ...
        <div class="col-xl-6 col-lg-6 mb-4">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text">Data Gallery</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-6 col-lg-6 mb-4">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text">Data Video</h6>
                </div>
                <div class="card-body">
                    ...
                    <label class="form-check-label ">
                      <a href="<?php echo base_url('youtube'); ?>" style="margin-top: 105px;color: #2c3e50;position: relative;top:3px;color:#f29191;"><i class="lni-question-circle" style="color:#f29191;"></i>&nbsp Cara Menambahkan Video</a>
                    </label>
                    </div>
                    <div class="col mt-3">
