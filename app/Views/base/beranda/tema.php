    ...
    <div class="container align-items-end justify-content-center d-flex">
      <div class="row align-items-top text-center">
        <div class="col-12 col-md-12 col-lg-12">
          <h1 class="subjudul">Pilih Tema</h1>
          <p class="lead_subjudul">Tersedia banyak pilihan tema undangan yang menarik untuk pernikahanmu..</p>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12 mt-5">
            <div class="fdb-box p-0">
              ...
              <div class="d-flex justify-content-center">
                <p class="mt-2 mr-2"><a href="<?php echo base_url('order/' . $row->kode_theme) ?>" class="btn btn-warning btn-sm">Pesan</a></p>
