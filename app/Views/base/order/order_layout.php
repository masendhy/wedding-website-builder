          ...
          <nav class="navbar navbar-expand-md fixed-top">
            <div class="container">
              <a class="navbar-brand navbar-order" href="<?php echo base_url() ?>">
                <img src="<?php echo base_url() ?>/assets/base/img/logo1.png?cache<?= date("Y-m-d"); ?>" height="50" alt="image">
              </a>
            </div>
          </nav>
        </div>
    ...
    <div class="container">
      <div class="col-12 text-lg-left">
        <p class="lead footer-social">
          <a href="https://twitter.com/heejra" target="blank" class="mx-2"><i class="lni-twitter-filled" aria-hidden="true"></i></a>
          <a href="https://facebook.com/heejra" target="blank"class="mx-2"><i class="lni-facebook-filled" aria-hidden="true"></i></a>
          <a href="https://instagram.com/heejra"target="blank" class="mx-2"><i class="lni-instagram-filled" aria-hidden="true"></i></a>
        </p>
      </div>
