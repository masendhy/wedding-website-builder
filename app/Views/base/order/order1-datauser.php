          ...
          <div class="col-12 col-md-8 col-lg-8 col-xl-6">
            <div class="row">
              <div class="col text-center">
                <h1 style="color: #f39191;margin-bottom:0px;">Hallo!</h1>
            ...
            <div class="row align-items-center">
              <div class="col mt-4">
                ...
                <label style="bottom: -12.3px;position: inherit;padding-left: 20px;color: #f39191;font-weight: bold;display: table;margin-bottom: -1.2rem;">weddingpage.website/</label>
                <input name="domain" type="text" class="form-control" placeholder="" style="padding-left: 180px;" value="<?php echo $domain; ?>"  onkeyup="nospaces(this)" required>
              </div>
            </div>
            ...
            <div class="row justify-content-start mt-4" >
              <div class="col">
                <div class="row">
                  <div class="col">
                    <!-- <a class="btn btn-primary btn-order btn-block" style="background-color: #ffe5e2;">Lanjut</a> -->
                    <input class="btn btn-warning btn-order btn-block" type="submit" name="submit" value="Lanjut">
                  </div>
