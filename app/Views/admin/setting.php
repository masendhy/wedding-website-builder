            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input id="bank" class="form-control" placeholder="Contoh : Bank Jagoo" value="<?= $setting[0]->nama_bank ?>" required>
                    </div>

                    <div class="form-group">
                        <label>Nomor Rekening</label>
                        <input id="norek" type="text" class="form-control" placeholder="Contoh : 123456789" value="<?= $setting[0]->norek ?>" required>
                    </div>

                    <div class="form-group">
                        <label>Nama Pemilik Rekening</label>
                        <input id="nama" type="text" class="form-control" placeholder="Contoh : John Due" value="<?= $setting[0]->nama_pemilik ?>" required>
                    </div>
