...
define('SITE_NAME', 'weddingpage'); ///NAMA WEBSITE

// =========== production mode ============
//LINK DOMAIN WITH URL
// define('SITE_UTAMA', 'https://www.weddingpage.website/'); 
// define('SITE_UNDANGAN', 'https://undangan.weddingpage.website');
// define('SITE_ADMIN', 'https://admin.weddingpage.website');

// //DOMAIN ONLY
// define('DOMAIN_UTAMA', 'weddingpage.website');
// define('DOMAIN_UTAMA_WWW', 'www.weddingpage.website'); //PAKE WWW
// define('DOMAIN_UNDANGAN', 'undangan.weddingpage.website');
// define('DOMAIN_ADMIN', 'admin.weddingpage.website');
